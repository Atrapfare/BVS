...
public class Storage {
    ...
    public Book searchBookByISBN(String isbn) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("io.github.bvs.objects.Book not found!");
    }
    ...
    public BookCopy searchBookCopyById(long id) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("io.github.bvs.objects.BookCopy not found!");
    }
    ...
    public Customer searchCustomerById(long id) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("io.github.bvs.objects.Customer not found!");
    }
